...
using KPI.Filtering.Website;
using KPI.Filtering.Website.Models;
...
namespace KPI.Filtering.Website.Controllers
{
    ...
    public class KPIFilterController : ControllerBase
    {
        ...
        {
            return Content(outputDataSource.OutputDataSource(), "application/xml");
        }
        ...
        public IActionResult ExportFilterConditions([FromBody]OutputDataSource outputDataSource)
        {
            try
            {
                ...
                resultXml.LoadXml(outputDataSource.OutputDataSource());
